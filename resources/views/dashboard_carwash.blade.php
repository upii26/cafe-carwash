            ...
            <div class="flex-1 p-4 md:p-6 pb-20 lg:pb-6">
                ...
                <div class="grid grid-cols-2 lg:grid-cols-2 gap-3 md:gap-4 mb-5">
                    ...
                    <div
                        ...
                        <div class="text-[10px] text-[#000] mt-1">Target hari ini: 100</div>
                    </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-5">
                    ...
                    <div
                        ...
                        {{-- SVG Bar Chart --}}
                        <div class="relative flex items-end gap-1.5 h-44 md:h-52
                        bg-white/40 rounded-xl p-3
                        border-b border-black/10
                        shadow-inner"
                            id="barChart">
                            {{-- rendered by JS --}}
                        </div>
                        <div class="flex justify-between mt-3 text-[10px] text-black/60 font-medium" id="barLabels">
                        </div>
                    </div>
