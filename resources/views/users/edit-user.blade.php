...
<body class="bg-[#F2F2F0] min-h-screen overflow-x-hidden">
        ...
        <div class="main-layout flex flex-1 overflow-hidden">
            <div class="flex-1 overflow-y-auto p-5 pb-24">
                ...
                <div class="flex items-center gap-3 mb-5">
                    ...
                    <div>
                        <div class="text-base font-extrabold text-gray-900">Edit User</div>
                        <div class="text-xs text-gray-400 mt-0.5">Manajemen User › {{ $user->name }}</div>
                    </div>
                </div>

                <form action="/users/{{ $user->id }}" method="POST" id="userForm">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="bg-white rounded-2xl p-5 shadow-sm border border-black/[.07]">
                            ...
                            <div class="flex flex-col gap-4">
                                ...
                                <div class="flex items-center gap-3 pb-3 border-b border-gray-100">
                                    ...
                                    <div>
                                        <div class="text-sm font-bold text-gray-800" id="avatarName">{{ $user->name }}</div>
                                ...
                                <div class="flex flex-col gap-1.5">
                                    <label class="text-xs font-bold uppercase tracking-wide text-gray-500">
                                        Password Baru
                                        <span class="normal-case font-normal text-gray-300 ml-1">(kosongkan jika tidak diubah)</span>
                                    </label>
                                    <div class="relative">
    ...
    <script>
        function selectRole(role) {
            ...
            ['owner', 'kasir'].forEach(function(r) {
        ...
        // Update avatar inisial live saat nama diubah
        function updateAvatar() {
            var name = document.getElementById('userName').value.trim();
            var initials = name ? name.substring(0, 2).toUpperCase() : '??';
            document.getElementById('avatarCircle').textContent = initials;
            document.getElementById('avatarName').textContent   = name || 'Nama User';
        }
    </script>
